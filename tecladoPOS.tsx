...
const VirtualKeyboard = ({activeInputId, onInputChange}: VirtualKeyboardProps) => {
  ...
  return (
    ...
    <div
          className={`virtual-keyboard ${tecladoVisibles ? 'seleccionado' : ''}`}
          style={{
            position: 'absolute',
   ...
   { tecladoVisibles ?
   <>
   <div className={`bg-white teclado container-teclado`}>
   ...
   <form className='formsss'>
    <button className='btn text-danger buttonXe teclado-styles' onClick={handleCloseTeclado}><IoMdClose/></button>
       ...
       :
       <>
           <div className={`box containerTc 'teclado-letras-visible' `}>
